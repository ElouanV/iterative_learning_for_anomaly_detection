from models.deepsvdd.networks.tabular_net import TabularNet
...
def build_network(net_name, input_dim=None, model_config: dict = None):
    ...
    if net_name == "tabular":
        net = TabularNet(input_dim=input_dim, model_config=model_config)
    return net
